import { fromLocalStorage, deleteFromLocalStorage, changeStatusFromLocalStorage } from "./local-storage"
...
export default function allToDoCreatingFunction(containerId) {
    ...
    fromLocalStorage().forEach(toDo => {
        ...
        sharedContainer.append(title, description, dueDate, priority, status, deleteBtn, changeStatus);
